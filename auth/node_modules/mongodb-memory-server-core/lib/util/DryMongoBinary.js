...
const getos_1 = (0, tslib_1.__importStar)(require("./getos"));
...
class DryMongoBinary {
    ...
    static generateOptions(opts) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            log('generateOptions');
            const defaultVersion = (_a = (0, resolveConfig_1.resolveConfig)(resolveConfig_1.ResolveConfigVariables.VERSION)) !== null && _a !== void 0 ? _a : '4.0.25';
            const ensuredOpts = (0, utils_1.isNullOrUndefined)(opts)
                ? { version: defaultVersion }
                : opts;
            if ((0, utils_1.isNullOrUndefined)(this.cachedGetOs)) {
                this.cachedGetOs = yield (0, getos_1.default)();
            }
            const final = {
    ...
    static getBinaryName(opts) {
        log('getBinaryName');
        const addExe = (0, os_1.platform)() === 'win32' ? '.exe' : '';
