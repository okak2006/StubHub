...
class MongoBinaryDownload {
    ...
    startDownload() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield (0, mkdirp_1.default)(this.downloadDir);
            try {
    ...
    makeMD5check(urlForReferenceMD5, mongoDBArchive) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            const mongoDBArchiveMd5 = yield this.download(urlForReferenceMD5);
            const signatureContent = (yield fs_1.promises.readFile(mongoDBArchiveMd5)).toString('utf-8');
            const regexMatch = signatureContent.match(/^\s*([\w\d]+)\s*/i);
            const md5Remote = regexMatch ? regexMatch[1] : null;
            const md5Local = md5_file_1.default.sync(mongoDBArchive);
            log(`makeMD5check: Local MD5: ${md5Local}, Remote MD5: ${md5Remote}`);
            if (md5Remote !== md5Local) {
                throw new errors_1.Md5CheckFailedError(md5Local, md5Remote || 'unknown');
            }
            yield fs_1.promises.unlink(mongoDBArchiveMd5);
            return true;
        });
    }
    /**
    ...
    extract(mongoDBArchive) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield (0, mkdirp_1.default)(path_1.default.dirname(mongodbFullPath));
            const filter = (file) => /(?:bin\/(?:mongod(?:\.exe)?)|(?:.*\.dll))$/i.test(file);
    ...
    extractZip(mongoDBArchive, extractPath, filter) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            log('extractZip');
            return new Promise((resolve, reject) => {
                yauzl_1.default.open(mongoDBArchive, { lazyEntries: true }, (e, zipfile) => {
                    if (e || !zipfile) {
                        return reject(e);
                    }
                    zipfile.readEntry();
