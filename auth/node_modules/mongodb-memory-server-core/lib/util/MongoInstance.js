...
class MongoInstance extends events_1.EventEmitter {
            ...
            if (!(0, utils_1.isNullOrUndefined)(this.mongodProcess)) {
                ...
                if (this.isReplSet) {
                    ...
                    try {
                        ...
                        con = yield mongodb_1.MongoClient.connect((0, utils_1.uriTemplate)(ip, port, 'admin'), Object.assign({ useNewUrlParser: true, useUnifiedTopology: true }, this.extraConnectionOptions));
    ...
    stdoutHandler(message) {
        ...
        if (/transition to \w+ from \w+/i.test(line)) {
            const state = (_d = (_c = /transition to (\w+) from \w+/i.exec(line)) === null || _c === void 0 ? void 0 : _c[1]) !== null && _d !== void 0 ? _d : 'UNKNOWN';
