...
class MongoMemoryServer extends events_1.EventEmitter {
    ...
    start(forceSamePort = false) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            if ((0, utils_1.isNullOrUndefined)((_b = this.opts.instance) === null || _b === void 0 ? void 0 : _b.replSet) &&
                process
    ...
    stop(runCleanup = true) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            (0, utils_1.assertion)(!(0, utils_1.isNullOrUndefined)(this._instanceInfo.instance), new Error('"instanceInfo.instance" is undefined!'));
    ...
    getUri(otherDb) {
        ...
        return (0, utils_1.uriTemplate)(this._instanceInfo.ip, this._instanceInfo.port, (0, utils_1.generateDbName)(otherDb));
    }
    /**
